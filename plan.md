...
- **상태**: **구현 완료(2026-08-01)**. 배포 후 확인 — ① 홈 카드에 `7월 평균 7.47% · 전월 +2.30%p`가 뜨는지(한 줄 폭이 아이폰에서 접히지 않는지 — §86.1 전례) ② 상세에 「7월 일별 기록」 22건이 뜨는지 ③ **8/3(월) 첫 회차 후 기준월이 8월로 넘어가고** 라벨이 「8월 평균」·「8월 일별 기록」으로 바뀌는지.
